...
var episode_actions = [arg('tvdb_id', true), arg('imdb_id', true), arg('title'), arg('year'), arg('season'), arg('episode')]
...
var show_actions = [arg('tvdb_id', true), arg('imdb_id', true), arg('title'), arg('year')]
...
var api = {
	...
	'movie' : [
		...
		{ method: 'checkin', type: 'POST', parameters: movie_actions }, // DEV
	...
	'show' : [ // TODO: Specify missing parameters
		{ method: 'cancelcheckin', type: 'POST', parameters: [] }, // DEV
		{ method: 'cancelwatching', type: 'POST', parameters: [] }, // DEV
		{ method: 'checkin', type: 'POST', parameters: show_actions.concat([arg('episodes')]) }, // DEV
